  ...
  <div className="bg-white border border-gray-100 rounded-lg p-4 flex gap-4 shadow-sm hover:shadow-md transition-shadow">
    ...
    <div className="flex flex-col justify-between flex-1 text-left">
      ...
      <div className="flex justify-between items-center mt-2">
        ...
        <button className="bg-pink-600 text-white text-[10px] px-3 py-1 rounded-full hover:bg-pink-700">
          Add To Cart
        </button>
      </div>
    </div>
...
const FlashSaleCard = ({ img, title, price, oldPrice }) => (
  <div className="bg-[#3B2F4A] text-white rounded-lg p-3 relative group">
    <div className="absolute top-2 left-2 bg-pink-600 text-[8px] px-2 py-0.5 rounded z-10">
      SALE
    </div>
    ...
    <div className="w-full bg-white">
      ...
      <div className="bg-[#3B2F4A] py-16 text-white">
        <div className="container mx-auto px-10 md:px-24 text-center">
          ...
          <p className="text-gray-300 text-xs mb-10 max-w-md mx-auto">
            Check out our most popular books of the week from gripping thrillers
            to inspiring biographies.
          </p>
      ...
      <div className="container mx-auto py-16 px-10 md:px-24">
        <h2 className="text-xl text-gray-700 font-bold mb-8 text-left">
          Recommended For You
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <RecommendedCard
            ...
            price="30.00"
            desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et ultricies est. Aliquam in justo varius, sagittis neque ut, malesuada leo. Aliquam in justo varius, Aliquam in justo varius,"
          />
          <RecommendedCard
            img="/book4.png"
      ...
      <div className="container mx-auto pb-20 px-10 md:px-24 ">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="bg-pink-100 text-pink-600 font-bold px-3 py-1 rounded-full text-sm">
            30:00:00
          </div>
        </div>
